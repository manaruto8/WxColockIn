...
Page({
  ...
  /**
     ...
     */
  afterTapDay(e) {
    var isStart = this.data.startSwitch
    var selectDate = e.detail
    this.setData({
      selectDates: e,
    })
    
    var dates = this.calendar.getCalendarDates();
  ...
  bindStartSwitch(e) {
    ...
    this.setData({
      startSwitch:e.detail
    })
    this.afterTapDay(this.data.selectDates)
  },
